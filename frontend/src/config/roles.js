...
export const NAV_BY_ROLE = {
  ...
  case_manager: [
    ...
    { label: "OP CM Tracker", path: "/reports/op-cm-tracker", icon: "reports" },
    { label: "Analytics", path: "/analytics", icon: "analytics" },
    { label: "Archives", path: "/settings/archives", icon: "archives" },
  ],
  him_staff: [
    { label: "Dashboard", path: "/dashboard", icon: "dashboard" },
...
export const ROLE_PERMISSIONS = {
  ...
  case_manager: [
    ...
    "Log milestones, drug test results, and comorbidities",
    "Process patient discharges",
    "Full access to OP CM Tracker for assigned caseload",
    "Export OP CM Tracker to Excel",
    "Schedule and resolve follow-ups",
    "Generate patient certificates",
    "View analytics for assigned caseload",
    "View archived records for assigned patients",
  ],
  him_staff: [
