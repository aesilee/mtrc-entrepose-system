  ...
  return (
    <div className="report-print-area" style={{ ...styles.card, padding: compact ? 24 : 36 }}>
      ...
      <div style={styles.frame}>
        <div style={styles.eyebrow}>{isEnrollment ? "Certificate of Enrollment" : "Certificate of Completion"}</div>
        ...
        {isEnrollment ? (
          <p style={styles.body}>
            has completed the required admission process and is officially enrolled
            effective <strong>{fmtDate(c.admissionDate)}</strong>
            {c.program && c.program !== "—" ? <> under the <strong>{c.program}</strong> program</> : null}.
          </p>
        ) : (
          <p style={styles.body}>
