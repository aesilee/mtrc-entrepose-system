...
const styles = {
  ...
  refreshBtn: { background: "none", border: "none", color: "var(--color-text-muted)", cursor: "pointer", display: "flex", padding: 4 },
    tabBar: { display: "flex", flexShrink: 0, gap: 4, padding: "10px 12px 8px", overflowX: "auto", overflowY: "hidden" },
    tabBtn: { display: "flex", alignItems: "center", gap: 5, height: 28, padding: "0 10px", fontSize: 12.5, fontWeight: 600, color: "var(--color-text-muted)", background: "none", border: "none", borderRadius: 999, cursor: "pointer", whiteSpace: "nowrap", flexShrink: 0, boxSizing: "border-box" },
